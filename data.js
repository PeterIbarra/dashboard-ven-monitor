...
const WEEKS_DASHBOARD = [
  ...
  },
  {
    ...
    kpis: {
      energia: { exportaciones:'788 kbd · récord 7 años · 4° prov. EE.UU. (339K bpd)', ingresos:'Crudo +10% tensión Irán · proy. USD 100/bbl · 1.000 kg oro en negociación', licencias:'Shell acuerdos firmados · Exxon equipo técnico inminente · Gold Reserve OFAC temporal', tipo_cambio:'Brecha >50% persistente · SENIAT +78% vs ene · PIB Q4 2025: +7,07%' },
      ...
      opinion: { direccion:'MCM: 106,84 pts (78% máx.) · Guanipa: 102,24 · E.González: 91,13', elecciones:'H.R. 7674: estrategia transición en 180 días · Delcy: 25,3 pts', favorabilidad_mcm:'Retorno inminente MCM · agenda 3 prioridades · Ramos Allup: respalda MCM si necesario', aprobacion_eeuu:'Restablecimiento formal relaciones diplomáticas · AA autorizado' },
    },
    semaforos: { verde:8, amarillo:6, rojo:4 },
    tensiones: [
      { nivel:'green',  texto:'<strong>Restablecimiento diplomático:</strong> Relaciones formales EE.UU.–Venezuela. Visita Burgum con empresarios. American Airlines autorizado. Trump: 100M barriles confirmados.' },
      { nivel:'green',  texto:'<strong>Petróleo récord:</strong> 788K bpd — máximo en 7 años. 4° proveedor a EE.UU. (339K bpd). SENIAT +78% vs enero. PIB Q4 2025: +7,07%.' },
      { nivel:'yellow', texto:'<strong>Amnistía — brecha narrativa:</strong> 9.060 solicitudes; 5.628 libertades plenas (oficial) vs 568 presos activos (Foro Penal, 25 feb) y 529 pendientes (PUD).' },
      { nivel:'yellow', texto:'<strong>Retorno MCM:</strong> Anuncia retorno en próximas semanas. Índice liderazgo 106,84 pts. Variable definitoria hacia E1. 47+ meses sin ajuste salarial.' },
      { nivel:'red',    texto:'<strong>Agenda electoral:</strong> H.R. 7674 exige estrategia transición en 180 días. Sin calendario. Dependencia OFAC como única ancla macro.' },
    ],
    matrixXY: { x:0.155, y:0.440 },
    draft: false
  },
];
