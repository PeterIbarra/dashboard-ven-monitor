...
const CURRENT_WEEK_INDEX   = 7;
const CURRENT_SITREP_LABEL = "27 feb — 6 mar 2026 · Semana 8";
const PREV_SITREP_LABEL    = "20 — 27 feb 2026 · Semana 7";
...
const weeks = [
  ...
  {
    label: '27 feb–6 mar',
    lectura: 'La semana del 27 de febrero al 6 de marzo marca el punto de mayor densidad diplomática del ciclo y abre una bifurcación que definirá el arco de los próximos meses. El restablecimiento formal de relaciones diplomáticas entre EE.UU. y Venezuela —junto a la visita del Secretario de Interior Doug Burgum acompañado de empresarios del sector energético, la autorización a American Airlines para operar, la licencia temporal OFAC a Gold Reserve para retomar producción en el Arco Minero, y el anuncio de Trump de haber recibido ya 100 millones de barriles de petróleo venezolano— confirman que la arquitectura bilateral ha alcanzado un nivel de institucionalización sin precedentes desde hace dos décadas. Venezuela se convierte en el cuarto proveedor de crudo a EE.UU. con 339.000 barriles diarios, y las exportaciones totales alcanzan 788.000 bpd —el nivel más alto en siete años—. El PIB del Q4 2025 creció 7,07% interanual, y la recaudación del SENIAT en febrero superó en un 78% la de enero.<br><br>El vector que introduce mayor incertidumbre en el mapa de escenarios es el liderazgo opositor. MCM anuncia su retorno inminente a Venezuela con una agenda estructurada en tres prioridades: amnistía plena, cronograma electoral y recuperación institucional. Su índice de liderazgo alcanza 106,84 puntos (78% de intensidad máxima), seguida de Henri Ramos Allup con 102,24 y Enrique González con 91,13. Ramos Allup declara que respaldaría a MCM como candidata presidencial si ella lo decide. Delcy Rodríguez obtiene apenas 25,3 puntos en el mismo índice. La negociación de 1.000 kg de lingotes de oro entre el gobierno venezolano y EE.UU. como parte del esquema bilateral añade un elemento nuevo: la monetización de activos estratégicos como mecanismo de sostenibilidad del acuerdo.<br><br>E3 se mantiene en 40% como escenario dominante, pero E1 sube a 38% —la brecha más pequeña del ciclo— reflejando que la combinación de densidad diplomática, retorno de MCM y presión legislativa (H.R. 7674, que exige una estrategia de transición en 180 días) empuja el sistema hacia una bifurcación real. El crudo sube un 10% por tensiones con Irán, lo que refuerza el valor estratégico del suministro venezolano para Washington. E2 baja a 12%: el colapso no tiene vectores de activación inmediatos, pero la brecha cambiaria persistente (>50%), los 47 meses sin ajuste salarial y la canasta básica de USD 550 frente a ingresos de ~USD 270 mantienen la presión estructural. E4 se sostiene en 10%: el aparato de coerción selectiva sigue operativo y la ausencia de calendario electoral es un indicador de resiliencia del modelo de control.',
    shortLabel: '27F–6M',
    moveReason: 'E1 sube a 38% — brecha mínima con E3 (40%). Retorno MCM + restablecimiento diplomático + H.R. 7674 abren bifurcación real. E2 baja a 12% por solidez del esquema energético.',
    probs: [
      { sc: 1, label: 'Media-alta', value: 38, drivers: ['Retorno inminente MCM con agenda 3 prioridades: amnistía plena, calendario electoral, recuperación institucional', 'MCM: 106,84 pts liderazgo (78% intensidad) — Delcy Rodríguez: 25,3 pts (abismo de legitimidad)', 'H.R. 7674: Congreso EE.UU. exige estrategia de transición en 180 días', 'Ramos Allup: respaldaría a MCM como candidata presidencial si ella lo decide', 'Restablecimiento formal de relaciones diplomáticas EE.UU.–Venezuela'], signals: ['Retorno físico de MCM y recepción sin detención ni represalia', 'Anuncio de calendario electoral o compromisos verificables con fecha', 'Respuesta del Ejecutivo al H.R. 7674 con plan concreto', 'Ampliación verificable de amnistía a casos excluidos', 'Designaciones definitivas en Poder Ciudadano con perfil técnico'] },
      { sc: 2, label: 'Baja', value: 12, drivers: ['Brecha cambiaria >50% persistente (estructura no resuelta)', 'Canasta básica USD 550 vs ingreso promedio ~USD 270 — 47+ meses sin ajuste salarial', 'FMI: deuda >180% PIB, inflación tres dígitos, "Intensa Fragilidad" institucional', 'Dependencia absoluta del flujo OFAC como única ancla macroeconómica', 'Sector eléctrico sin inversión visible: 14,8h sin suministro promedio'], signals: ['Suspensión o revocación de licencias OFAC por incumplimiento de condiciones', 'Fractura pública en la FANB o ruptura del eje Delcy–Washington', 'Colapso del tipo de cambio con impacto en cadena de suministro', 'Retorno fallido de MCM con represalia o detención', 'Escalada de conflictividad social por deterioro de servicios o salarios'] },
      { sc: 3, label: 'Alta (dominante)', value: 40, drivers: ['Restablecimiento formal relaciones diplomáticas EE.UU.–Venezuela: hito institucional sin precedentes', 'Visita Burgum con empresarios energéticos: agenda de largo plazo consolidada', '788K bpd — récord 7 años; 4° proveedor EE.UU. (339K bpd); Trump: 100M barriles recibidos', 'PIB Q4 2025: +7,07%; SENIAT: +78% recaudación vs enero', 'Shell, Exxon (equipo técnico inminente), Gold Reserve (licencia OFAC): expansión inversora', 'Amnistía: 9.060 solicitudes; 5.628 libertades plenas (oficial); 31 militares incluidos', 'Negociación 1.000 kg lingotes oro — monetización de activos estratégicos'], signals: ['Flujo sostenido exportaciones >750K bpd hacia EE.UU. e India', 'Despliegue equipo técnico Exxon y avance contratos Shell gasíferos', 'Continuidad plan 3 fases SOUTHCOM', 'Estabilización progresiva brecha cambiaria', 'Reunión Petro–Delcy (Cúcuta) con acuerdo político conjunto'] },
      { sc: 4, label: 'Baja', value: 10, drivers: ['529 casos pendientes (PUD) + 568 presos activos (Foro Penal) — amnistía incompleta', 'Ausencia total de calendario electoral: H.R. 7674 sin respuesta formal', 'Aparato de coerción selectiva operativo paralelo al discurso de reconciliación', 'Concentración de encargados en Poder Ciudadano — cierre institucional sin pluralismo', 'Reacomodo FANB bajo presión SOUTHCOM: lealtades en redefinición'], signals: ['Detención o represalia contra MCM en su retorno', 'Anuncio descartando explícitamente calendario electoral en 2026', 'Nuevas detenciones de alto perfil durante vigencia de la amnistía', 'Discurso oficial endurecido frente al H.R. 7674', 'Suspensión de designaciones definitivas en Poder Ciudadano'] },
    ],
    points: [{ sc: 1, x: 88, y: 308 }, { sc: 2, x: 88, y: 88 }, { sc: 3, x: 418, y: 338 }, { sc: 4, x: 408, y: 88 }],
    active: 3, activeXY: { x: 210, y: 245 },
    trendSc: 1,
    trendDrivers: ['Retorno MCM + H.R. 7674: presión hacia E1 en su nivel más alto del ciclo', 'Restablecimiento diplomático formal EE.UU.–Venezuela cierra el ciclo de reconocimiento bilateral', '788K bpd + PIB +7,07%: ancla energética más sólida del período — sostiene E3 pero presiona hacia E1'],
  },
...
const WEEKS_DASHBOARD = [
  ...
  {
    label: '27 feb–6 mar 2026', short: '27F–6M',
    scenarios: [
      { id:1, name:'Transición política pacífica', prob:38, trend:'up'   },
      { id:2, name:'Colapso y fragmentación',      prob:12, trend:'down' },
      { id:3, name:'Continuidad negociada',         prob:40, trend:'flat' },
      { id:4, name:'Resistencia coercitiva',        prob:10, trend:'flat' },
    ],
    kpis: {
      energia: { exportaciones:'788 kbd · récord 7 años · 4° prov. EE.UU. (339K bpd)', ingresos:'Crudo +10% tensión Irán · Gold Reserve OFAC · 1.000 kg oro negociación', licencias:'Shell acuerdos · Exxon equipo técnico inminente · Gold Reserve temporal', tipo_cambio:'Brecha >50% persistente · SENIAT +78% vs ene · PIB Q4: +7,07%' },
      economico: { inflacion:'~174% proy. 2026 · 47+ meses sin ajuste salario mínimo', ingresos_pob:'69,5% < USD 300 · canasta USD 550 (Caracas USD 622)', electricidad:'14,8h sin suministro promedio · 52,8% empresas eval. negativa', pib:'+7,07% Q4 2025 · SENIAT +78% vs enero · proy. 10,4–15,2% 2026' },
      opinion: { direccion:'MCM: 106,84 pts (78%) · Ramos Allup: 102,24 · E.González: 91,13 · Delcy: 25,3', elecciones:'H.R. 7674: estrategia transición en 180 días · sin calendario del Ejecutivo', favorabilidad_mcm:'Retorno inminente · agenda 3 prioridades · Ramos Allup la respalda', aprobacion_eeuu:'Restablecimiento formal relaciones diplomáticas · AA autorizado' },
    },
    semaforos: { verde:8, amarillo:6, rojo:4 },
    tensiones: [
      { nivel:'green',  texto:'<strong>Restablecimiento diplomático:</strong> Relaciones formales EE.UU.–Venezuela. Visita Burgum con empresarios. American Airlines autorizado. Trump: 100M barriles recibidos.' },
      { nivel:'green',  texto:'<strong>Petróleo récord:</strong> 788K bpd — máximo en 7 años. 4° proveedor EE.UU. (339K bpd). SENIAT +78% vs enero. PIB Q4 2025: +7,07%.' },
      { nivel:'yellow', texto:'<strong>Amnistía — brecha narrativa:</strong> 9.060 solicitudes; 5.628 libertades plenas (oficial) vs 568 presos activos (Foro Penal) y 529 pendientes (PUD).' },
      { nivel:'yellow', texto:'<strong>Retorno MCM:</strong> Anuncia retorno inminente con agenda 3 prioridades. Índice liderazgo 106,84 pts. Variable definitoria hacia E1 vs E3.' },
      { nivel:'red',    texto:'<strong>Agenda electoral:</strong> H.R. 7674 exige estrategia transición en 180 días. Sin calendario del Ejecutivo. 47+ meses sin ajuste salarial.' },
    ],
    matrixXY: { x:0.148, y:0.425 },
    draft: false
  },
];
