...
const WEEKS_DASHBOARD = [
  ...
  },
  {
    ...
    kpis: {
      energia: { exportaciones:'788 kbd · récord 7 años · 4° prov. EE.UU.', ingresos:'Crudo +10% tensión Irán · proy. USD 100/bbl', licencias:'Shell acuerdos + Exxon equipo técnico · Gold Reserve OFAC', tipo_cambio:'Brecha >50% · presión estructural persistente' },
      economico: { inflacion:'~174% proy. · 47+ meses sin ajuste salarial', ingresos_pob:'69,5% < USD 300 · canasta USD 550', electricidad:'14,8h sin suministro promedio', pib:'+7,07% Q4 2025 · SENIAT +78% vs ene · proy. 10,4–15,2% 2026' },
      opinion: { direccion:'MCM 106,84 pts (78%) · Guanipa 102,24 · E.González 91,13', elecciones:'H.R. 7674: estrategia transición en 180 días', favorabilidad_mcm:'Retorno inminente MCM · 3 prioridades estructuradas', aprobacion_eeuu:'Restablecimiento formal relaciones diplomáticas · AA autorizado' },
    },
    semaforos: { verde:8, amarillo:6, rojo:4 },
    tensiones: [
      { nivel:'green',  texto:'<strong>Restablecimiento diplomático:</strong> Relaciones formales EE.UU.–Venezuela. Visita Burgum. American Airlines autorizado. Trump: 100M barriles confirmados.' },
      { nivel:'green',  texto:'<strong>Petróleo récord:</strong> 788K bpd — nivel más alto en 7 años. 4° proveedor a EE.UU. (339K bpd). SENIAT +78% vs enero. PIB Q4 2025: +7,07%.' },
      ...
      { nivel:'yellow', texto:'<strong>Retorno MCM:</strong> Anuncia retorno en próximas semanas con agenda 3 prioridades. Variable de alto impacto sobre E1/E3. 47+ meses sin salario mínimo.' },
      { nivel:'red',    texto:'<strong>Agenda electoral:</strong> H.R. 7674 exige estrategia transición en 180 días. Sin calendario. Dependencia del flujo OFAC como única ancla macro.' },
    ],
